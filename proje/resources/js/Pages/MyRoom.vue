<template>
<!-- frontend part for the my room page -->
                ...
                <div class="border-t border-gray-200 px-4 py-5 sm:p-0">
                  <dl class="sm:divide-y sm:divide-gray-200">
                    ...
                    >
                      ...
                      >
                        <button
                          @click="update(userinfo.payments[0])"
                          v-if="userinfo.payments[0].status == 'Waiting'"
                          href="#"
                          class="
                            font-medium
                            text-indigo-600
                        ...
                        <div v-if="userinfo.payments[0].status != 'Waiting'">
                          -
                        </div>
                      </dd>
                    </div>
...
<script>
//javascript part for the my room
