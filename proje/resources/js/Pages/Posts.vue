        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
                    <div class="bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md my-3" role="alert" v-if="$page.message">
                      <div class="flex">
                        <div>
                          <p class="text-sm">{{ $page.message }}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <table class="table-fixed w-full">
                        ...
                        <tbody>
                            <tr v-for="row in posts" :key="row.id" class="text-gray-700">
