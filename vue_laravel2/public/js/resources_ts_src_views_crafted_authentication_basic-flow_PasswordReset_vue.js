...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  ...
  setup: function setup() {
    ...
    var onSubmitForgotPassword = function onSubmitForgotPassword(values) {
      ...
      (_a = submitButton.value) === null || _a === void 0 ? void 0 : _a.setAttribute("data-kt-indicator", "on"); // dummy delay
      ...
      setTimeout(function () {
        ...
        store.dispatch(_store_enums_StoreEnums__WEBPACK_IMPORTED_MODULE_2__.Actions.FORGOT_PASSWORD, values).then(function () {
          ...
          var error = Object.keys(store.getters.getErrors)[0]; // Alert then login failed
